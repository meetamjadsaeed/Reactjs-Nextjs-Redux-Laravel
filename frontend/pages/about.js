        ...
        <section class="dark-grey-text">
          <div class="row pr-lg-5">
            <div class="col-md-7 mb-4">
              <div class="view">
                <img
                  src="https://img2.goodfon.com/wallpaper/big/1/cf/devushka-knigi-fon-3358.jpg"
                  class="img-fluid"
                  alt="smaple image"
                  style={{
                    "border-radius": "5%",
          ...
          <p>
            Users can browse listings as per location but for listings posting
            user will need to buy the package which has been created by the
            admin user and with the bought package user will allow posting a
            specific number of listings.
          </p>
          ...
          <ListGroup>
            ...
            <ListGroup.Item>
              Display All Listings With Category ID
            </ListGroup.Item>
            <ListGroup.Item>Display All Listings</ListGroup.Item>
            <ListGroup.Item>
              Display Listings on the basis of current location
            </ListGroup.Item>
