      ...
      <form  onSubmit={handleSubmit}>
        ...
        <div className="row">
          <div className="col-sm-12 col-md-12 form-group">
            ...
            ></textarea> */}
             <input type="text" className="form-control" placeholder="Package Description" 
            onChange={(e) => setPost({ ...postDetails, content: e.target.value })}
            />
          </div>            
        ...
        <div className="row">
          ...
          <div className="col form-group">
            <input type="text" className="form-control" placeholder="Totals No of Listings allowed" 
            />
          </div>
