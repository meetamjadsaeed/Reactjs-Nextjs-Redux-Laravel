...
const PackageForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("http://127.0.0.1:8000/api/posts", requestOptions).then((response) =>
      response.json()
    );
  ...
  return (
    <>
      <div className="container">
        <h2 style={{ "text-align": "center" }}>Create An new Package</h2>
        <div className="row">
          <div className="col-8">
              ...
              <div className="row">
                <div className="col form-group">
                  <input
                    ...
                    onChange={(e) =>
                      setPost({ ...postDetails, tittle: e.target.value })
                    }
                  />
                </div>
                {/* <div className="col form-group">
              ...
              <div className="row">
                ...
                <div className="col form-group">
                  <input
                    type="text"
                    className="form-control"
                    placeholder="Totals No of Listings allowed"
                  />
                </div>
              </div>
              ...
              <div className="row">
                <div className="col form-group">
                  <input
                    ...
                    disabled
                    onChange={(e) =>
                      setPost({ ...postDetails, author_id: e.target.value })
                    }
                  />
                </div>
                ...
                <div className="col form-group">
                  <input
                    ...
                    disabled
                    onChange={(e) =>
                      setPost({ ...postDetails, category_id: e.target.value })
                    }
                  />
                </div>
