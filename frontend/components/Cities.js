...
const Cities = () => {
  ...
  listings.map((item)=>{
    return (
      <Link href={`http://localhost:3000/postswithcat/${item.category_id}`}>
                <div className="card" style={{'width': '400px','height': '400px'}}>
                  <img src="https://images.unsplash.com/photo-1519501025264-65ba15a82390?ixlib=rb-4.0.3&w=1080&fit=max&q=80&fm=jpg&crop=entropy&cs=tinysrgb" alt="" />
                </div>
                </Link>
           )
        }) : <p>loading...</p>
